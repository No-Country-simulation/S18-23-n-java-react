...
-- Here I perform an INSERT of 10 different number_of_rooms
...
INSERT INTO properties (owner_id, antiquity, built_area, country, description, maintenance_fees, price, property_type,
                        province, number_of_rooms, status, street_name, street_number, title, total_area, years_of_antiquity)
VALUES (@userId, 'UNDER_CONSTRUCTION', 200.00, 'Argentina', 'Casa en construcción con amplio jardín', 0.00, 250000.00,
        'HOUSE', 'Córdoba', 3, 'MAINTENANCE', 'Calle Falsa', '123', 'Casa con potencial en desarrollo', 350.00, 1);
...
SET @propertyId = LAST_INSERT_ID();  -- Asignar ID de la primera propiedad

-- Relacionar la primera propiedad con rooms
INSERT INTO property_room (property_id, room_id, quantity) VALUES
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Living room'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Kitchen'), 1);
...
SET @propertyId = LAST_INSERT_ID();  -- Asignar ID de la segunda propiedad

-- Relacionar la segunda propiedad con rooms
INSERT INTO property_room (property_id, room_id, quantity) VALUES
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Master bedroom'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Kitchen'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Living room'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Laundry room'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Half bath'), 1);
...
SET @propertyId = LAST_INSERT_ID();  -- Asignar ID de la tercera propiedad

-- Relacionar la tercera propiedad con rooms
INSERT INTO property_room (property_id, room_id, quantity) VALUES
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Master bedroom'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Kitchen'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Living room'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Garden'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Terrace'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Balcony'), 1);
...
SET @propertyId = LAST_INSERT_ID();  -- Asignar ID de la cuarta propiedad

-- Relacionar la cuarta propiedad con rooms
INSERT INTO property_room (property_id, room_id, quantity) VALUES
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Living room'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Half bath'), 1);
...
SET @propertyId = LAST_INSERT_ID();  -- Asignar ID de la quinta propiedad

-- Relacionar la quinta propiedad con rooms
INSERT INTO property_room (property_id, room_id, quantity) VALUES
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Living room'), 2), -- Dos living rooms para reflejar un edificio
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Kitchen'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Laundry room'), 1),
...
SET @propertyId = LAST_INSERT_ID();  -- Asignar ID de la sexta propiedad

-- Relacionar la sexta propiedad con rooms (por ser un galpón no tiene muchos rooms)
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Service quarters'), 1);
...
SET @propertyId = LAST_INSERT_ID();  -- Asignar ID de la propiedad
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Office'), 1);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Storage'), 1);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Commercial space'), 1);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Garage'), 1);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Master bedroom'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Lobby'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Kitchen'), 1);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Boat bed'), 1);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Land'), 1);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Hotel room'), 20);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Doctor office'), 1);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Commercial premises'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Storage room'), 1);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Hotel room'), 15);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Bedroom'), 1),
                                                               (@propertyId, (SELECT id FROM room WHERE name = 'Living room'), 1);
...
INSERT INTO properties (
    owner_id, antiquity, built_area, country, description, maintenance_fees, price, property_type,
    province, number_of_rooms, status, street_name, street_number, title, total_area, years_of_anticuity
) VALUES
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Warehouse'), 1);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Business asset'), 1);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Building'), 10);
...
INSERT INTO property_room (property_id, room_id, quantity) VALUES
    (@propertyId, (SELECT id FROM room WHERE name = 'Vacation home'), 1);
